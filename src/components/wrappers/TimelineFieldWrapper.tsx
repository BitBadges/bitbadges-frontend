...
export function TimelineFieldWrapper<T extends TimelineItem<bigint>>({ createNode, timeline, emptyNode = <>None</> }: { createNode: (val: T) => JSX.Element, timeline: T[], emptyNode?: JSX.Element }) {
  let defaultIdx = -1;
