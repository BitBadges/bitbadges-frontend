...
export function WalletHeader() {
  ...
  let disabled = false;
  const UserTabMenu = <Menu theme='dark' className='dropdown primary-text bg-slate-950 border-0 rounded-xl' style={{ minWidth: 350, alignItems: 'center', border: '1px solid gray', marginTop: 8, marginRight: 10, overflow: 'hidden' }}>
    ...
    {<>
      <Menu.Item className='dropdown-item text-sm text-vivid-blue' onClick={() => router.push('/account/codes')}>QR Codes</Menu.Item>
    </>}
    {connected && <>
