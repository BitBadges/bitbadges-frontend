...
export function CreateTxMsgUpdateUserIncomingApprovalsModal({
  collectionId,
  visible,
  setVisible,
  children
  ...
  const [newIncomingApprovals, setNewIncomingApprovals] = useState<Array<UserIncomingApprovalWithDetails<bigint>>>(
    collection?.owners.find((x) => x.cosmosAddress === chain.cosmosAddress)?.incomingApprovals ?? []
  );
