...
export function PreviewBadgePagesStepItem() {
  ...
  const maxBadgeId = collection ? collection.getMaxBadgeId() : 1n;
    ...
    node: () => (
      <div>
        ...
        <div className="primary-text flex-center">
          <div>
            <b style={{ fontSize: 18 }}>Page for Badge ID </b>
          </div>
          <InputNumber
            min={1}
            max={maxBadgeId > Number.MAX_SAFE_INTEGER ? Number.MAX_SAFE_INTEGER : Numberify(maxBadgeId.toString())}
