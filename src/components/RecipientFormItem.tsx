...
export function RecipientFormItem({ setRecipients, recipients }: {
    ...
    const [fileRecipients, setFileRecipients] = useState<any[]>([]);
    const [illegalEntries, setIllegalEntries] = useState<any[]>([]);
    ...
    function getCSV(file: any) {
        Papa.parse(file, {
            complete: (results: any) => {
                const data = results.data;
                const newRecipients: any[] = [];
                const illegalEntriesArr: any[] = [];
                        ...
                        <Input
                            addonBefore={
                                <Select
                                    ...
                                    onSelect={(e: any) => setAddedUserChain(e)}
                                    defaultValue="ETH"
                                >
                        ...
                        <div style={{ fontSize: 11 }}>
                            <Text style={{ color: 'lightgrey' }}>
                                *All CSV rows must be in the format:
                                chain,address,amount. Do not include any header
                                or footer rows.
                            </Text>
                        </div>
