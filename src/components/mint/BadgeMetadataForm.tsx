...
export function BadgeMetadataForm({
    setCurrStepNumber,
    newBadgeMsg,
    setNewBadgeMsg,
    ...
    console.log('individualBadgeMetadata', individualBadgeMetadata)
    //TODO: abstract all these to their own exportable components
    return (
        <>
            <CustomizeIndividualMetadataForm
                items={[
                    {
                        ...
                        node: <div>
                            ...
                            >
                                <Input
                                    value={individualBadgeMetadata[id]?.name}
                                    onChange={(e: any) => {
                                        let currMetadata = individualBadgeMetadata;
                                        currMetadata[id] = {
                                            ...currMetadata[id],
                                            name: e.target.value
                                        }
                                        setIndividualBadgeMetadata(currMetadata);
                                        setHack(!hack);
                                    }}
                                    style={{
                            ...
                            >
                                <Select
                                    className="selector"
                                    value={individualBadgeMetadata[id]?.image}
                                    onChange={(e) => {
                                        let currMetadata = individualBadgeMetadata;
                                        currMetadata[id] = {
                                            ...currMetadata[id],
                            ...
                            >
                                <Select
                                    className="selector"
                                    value={individualBadgeMetadata[id]?.category}
                            ...
                            >
                                <Input.TextArea
                                    value={individualBadgeMetadata[id]?.description}
                                    onChange={(e) => {
                                        let currMetadata = individualBadgeMetadata;
                                        currMetadata[id] = {
                                            ...currMetadata[id],
                        ...
                        >
                            <Input
                                value={individualBadgeMetadata[id]?.tags}
                                onChange={(e) =>
                                    setNewBadgeMsg({
                                        ...newBadgeMsg,
                                        metadata: {
                            ...
                            >
                                <Select
                                    className="selector"
                                    defaultValue={individualBadgeMetadata[id]?.color}
                                    onSelect={(e: any) => {
                                        let currMetadata = individualBadgeMetadata;
                                        currMetadata[id] = {
                                            ...currMetadata[id],
                            ...
                            >
                                <Input
                                    value={individualBadgeMetadata[id]?.externalUrl}
                                    onChange={(e) => {
                                        let currMetadata = individualBadgeMetadata;
                                        currMetadata[id] = {
                                            ...currMetadata[id],
