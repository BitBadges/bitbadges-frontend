...
export function ToolIcon({
  ...
  return (
    <Card hoverable style={{ margin: 8, maxWidth: 300, display: 'inline' }} className='primary-text inherit-bg tool-icon bg-slate-50 border-0 dark:bg-blue-black-100 rounded-lg'
      onClick={() => {
    ...
    >
      <div className='' style={{ alignItems: 'normal', width: '100%' }}>
        <div style={{ marginRight: 10 }} className='flex-around full-width'>
          <div>
            <Avatar size={40} src={tool.icon} shape='square' className='text-vivid-pink h-12' />
          </div>
          <div className='secondary-text full-width text-slate-700 dark:text-white' style={{ textAlign: 'center', alignItems: 'center' }}>
        ...
        <div className='flex-center flex-column ' style={{ marginTop: 16 }}>
          <div className='primary-text text-gray-400'>
            {tool.description}
          </div>
        </div>
      </div>
