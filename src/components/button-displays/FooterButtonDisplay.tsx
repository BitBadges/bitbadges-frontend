        ...
        <a href={githubLink} target="_blank" rel="noreferrer">
          <Tooltip title="GitHub" placement="bottom">
            <Avatar
              size="large"
              onClick={() => { }}
              className="styled-button account-socials-button border-0 bg-blue-black-100 text-vivid-pink"
              src={<GithubOutlined />}
            />
          </Tooltip>
        </a>
        ...
        <a href={telegramLink} target="_blank" rel="noreferrer">
          <Tooltip title="Telegram" placement="bottom">
            <Avatar
              ...
              onClick={() => { }}
              className="styled-button account-socials-button border-0 bg-blue-black-100 text-vivid-pink"
              src={<svg fill='#DA0C91' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 50 50">
