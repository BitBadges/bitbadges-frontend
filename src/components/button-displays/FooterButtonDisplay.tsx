import { FacebookOutlined, GithubOutlined, InstagramOutlined, LinkedinOutlined, RedditOutlined, SlackOutlined } from '@ant-design/icons';
        ...
        <a href={twitterLink} target="_blank" rel="noreferrer">
          <Tooltip title="X (formerly Twitter)" placement="bottom">
            <Avatar
              ...
              // /images/x-logo.svg
              src={
                <svg width="20" height="20" viewBox="0 0 1200 1227" fill="#1890ff" x="0px" y="0px" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href={telegramLink} target="_blank" rel="noreferrer">
          <Tooltip title="Telegram" placement="bottom">
            <Avatar
              ...
              className="styled-button account-socials-button border-0 bg-blue-black-100 text-vivid-blue hover:bg-transparent hover:opacity-80 "
              src={
                <svg fill="#1890ff" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 50 50">
        ...
        <a href={discordLink} target="_blank" rel="noreferrer">
          <Tooltip title="Discord" placement="bottom">
            <Avatar
              ...
              className="styled-button account-socials-button border-0 bg-blue-black-100 text-vivid-blue hover:bg-transparent hover:opacity-80 "
              src={
                <svg fill="#1890ff" xmlns="http://www.w3.org/2000/svg" height="0.8em" viewBox="0 0 640 512">
