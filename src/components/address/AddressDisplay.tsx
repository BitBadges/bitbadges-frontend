...
export function AddressDisplayTitle(
  ...
  return <div className='flex-between' style={{
    fontSize: 20
  }}>
...
export function AddressDisplayList(
  ...
  return <div style={{ maxHeight: 500, overflow: 'auto', color: fontColor ? fontColor : darkMode ? 'white' : undefined, fontSize: fontSize }}>
