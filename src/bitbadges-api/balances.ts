...
export const getPostTransferBalance = (balance: UserBalance, collection: BitBadgeCollection | undefined, startSubbadgeId: number, endSubbadgeId: number, amountToTransfer: number, numRecipients: number) => {
