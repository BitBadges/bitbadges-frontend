...
export const LandingCard = ({ content, customClass }: { content: JSX.Element; customClass: string }) => {
  return (
    <div className="flex">
      <Card
        className={customClass + ' card-bg rounded-lg'}
        style={{
          border: '1px solid gray'
        }}>
        <div className="landing-card secondary-text">{content}</div>
      </Card>
    </div>
  );
};
      ...
      <SignInWithBitBadgesButton
        onSignAndBlockinVerify={async () => {
          notification.success({
            message: 'Success',
            description: `On a site that uses Sign In with BitBadges, you would now be signed in if you met the authentication and badge ownership requirements.`
          });
        }}
        props={{
        ...
        popupParams={{
          ...
          description:
            'This is just an example for signing in with BitBadges. Websites can use this to authenticate users by outsourcing all authentication logic to a Sign In with BitBadges popup.',
      ...
      <div className="landing-padding gradient-bg">
        <Row className="flex-around " style={{ textAlign: 'start', flexWrap: 'wrap', alignItems: 'normal', minHeight: '60vh' }}>
          <Col md={14} sm={24} xs={24} style={{ alignItems: 'center', height: '100%', marginTop: '10vh' }}>
            <div
              className="collect-title capitalize primary-text flex flex-wrap"
              style={{
                alignItems: 'center'
              }}>
              <span className="mr-2">Collect </span>
              <img src="/images/bitbadgeslogotext.png" alt="BitBadges Logo" className="inline-logo primary-pink" /> to build your digital identity!
            </div>
            <br />
            <p className="secondary-text" style={{ fontSize: 14 }}>
              BitBadges is the <b>all-in-one</b>, multi-chain platform for creating, collecting, and verifying digital NFT badges. Build multi-chain,
              token-gated applications seamlessly all with one interface. This is a beta version of BitBadges which is completely free for users.{' '}
            </p>
              ...
              <div className="flex-center flex-wrap full-width primary-text ">
                {[...featuredBadges].map((badge) => {
                  ...
                  return ids.map((badgeId, idx) => {
                    return (
                      <div key={idx} className="flex-between flex-wrap" style={{ margin: 2, flexWrap: 'wrap' }}>
                        <BadgeAvatar
                          size={85}
        ...
        <Row className="grid grid-cols-1 gap-3 mt-12">
          <div className="grid lg:grid-cols-2 gap-10">
            <div>
              ...
              <Typography.Text className="secondary-text" style={{ fontSize: 14 }}>
                Badges can be collected in a variety of ways, such as scanning a QR code, entering a password, or being airdropped one. The collection
                creator decides how badges are distributed. To see how a specific collection distributes badges, check out the page for that
                collection. Oftentimes, badges will also be integrated into a custom website or application, allowing you to collect badges by
                interacting with the website or application rather than directly on BitBadges.
              </Typography.Text>
              ...
              <Typography.Text className="secondary-text" style={{ fontSize: 14 }}>
                ...
                This is possible because BitBadges uses a public, decentralized blockchain to store badges, meaning no one can censor, forge, or fake
                ownership of badges.
              </Typography.Text>
              <br />
              <br />
              ...
              <Typography.Text className="secondary-text" style={{ fontSize: 14 }}>
                Treat betanet as a public, subsidized testnet. This means that the platform is not yet intended for production use. Bugs and issues
                are expected. However, we believe it is stable enough to start using it and providing feedback. This allows us to build a better
                product for you in the long term!
                <br /> <br />
                Betanet is completely free to use for users. Once mainnet launches, badges and profiles can optionally be migrated. $BADGE will be
                redistributed via an airdrop based on betanet contributions.
              </Typography.Text>
            </div>
          ...
          <div
            ...
            <InformationDisplayCard noBorder inheritBg title="Utility" subtitle="" md={8} sm={24} xs={24}>
              <br />
              <BadgeAvatar size={150} collectionId={1n} badgeId={3n} /> <br />
              <div className="secondary-text" style={{ fontSize: 14 }}>
                Certain badges might offer utility, like access to an event or authenticating you for a website. For example, a ticket badge might get
                you into a concert.
              </div>
            </InformationDisplayCard>
            <InformationDisplayCard noBorder inheritBg title="Achievements" subtitle="" md={8} sm={24} xs={24}>
              <br />
              <BadgeAvatar size={150} collectionId={1n} badgeId={5n} /> <br />
              <div className="secondary-text" style={{ fontSize: 14 }}>
                Show off your achievement badges in your portfolio, like a degree or certification. Badges can be used to prove your skills and
                experience.
              </div>
            </InformationDisplayCard>
            <InformationDisplayCard noBorder inheritBg title="Reputation" subtitle="" md={8} sm={24} xs={24}>
              <br />
              <BadgeAvatar size={150} collectionId={1n} badgeId={9n} /> <br />
              <div className="secondary-text" style={{ fontSize: 14 }}>
                Your badges become your digital identity. Some might positively impact your reputation while others might negatively impact your
                reputation.
              </div>
            </InformationDisplayCard>
            ...
            <InformationDisplayCard noBorder inheritBg title="Contributions" subtitle="" md={8} sm={24} xs={24}>
              <br />
              <BadgeAvatar size={150} collectionId={1n} badgeId={6n} /> <br />
              <div className="secondary-text" style={{ fontSize: 14 }}>
            ...
            <InformationDisplayCard noBorder inheritBg title="For Fun" subtitle="" md={8} sm={24} xs={24}>
              <br />
              <BadgeAvatar size={150} collectionId={1n} badgeId={19n} /> <br />
              <div className="secondary-text" style={{ fontSize: 14 }}>
            ...
            <InformationDisplayCard noBorder inheritBg title="Protocols" subtitle="" md={8} sm={24} xs={24}>
              <br />
              <BadgeAvatar size={150} collectionId={1n} badgeId={15n} /> <br />
              <div className="secondary-text" style={{ fontSize: 14 }}>
                Use badges to implement protocols, such as the
                <a
                  href="https://docs.bitbadges.io/overview/ecosystem/bitbadges-follow-protocol"
                  target="_blank"
        ...
        <Row className="flex-between mt-4" style={{ alignItems: 'normal' }}>
          <Col md={24} sm={24} xs={24}>
            <Typography.Text strong className="secondary-text text-base secondary-text font-normal dark:text-slate-100" style={{ fontSize: 16 }}>
              ...
              Learn more about all offered features{' '}
              <a href="https://docs.bitbadges.io/overview" target="_blank" className="text-vivid-blue" rel="noreferrer">
                here
              </a>
              .
            </Typography.Text>
          ...
          <>
            <>
                ...
                content={
                  <>
                    <div className="flex flex-wrap" style={{ alignItems: 'center' }}>
                      <Avatar src={ETH_LOGO} size={48} style={{ marginRight: 8 }} />

                      <Avatar src={COSMOS_LOGO} size={48} style={{ marginRight: 8 }} />
                      <Avatar src={SOLANA_LOGO} size={48} style={{ marginRight: 8 }} />
                      <Avatar src={BITCOIN_LOGO} size={48} style={{ marginRight: 8 }} />
                    </div>
                    <br />
                    ...
                    <Typography.Text className="secondary-text" style={{ fontSize: 14, marginTop: 8 }}>
                      One interface for all chains. The same badge can be owned by Ethereum <Avatar src={ETH_LOGO} size={25} />, Solana{' '}
                      <Avatar src={SOLANA_LOGO} size={25} />, Bitcoin <Avatar src={BITCOIN_LOGO} size={25} />, and Cosmos{' '}
                      <Avatar src={COSMOS_LOGO} size={25} /> users.
              ...
              <LandingCard
                ...
                content={
                  <>
                    <ClusterOutlined className="figma-blue" style={{ fontSize: 48 }} />
                    <br />
                    <br />
                    <Typography.Text strong className="primary-text" style={{ fontSize: 20 }}>
                      Scalable
                    ...
                    <br /> <br />
                    <Typography.Text className="secondary-text" style={{ fontSize: 14, marginTop: 8 }}>
                      BitBadges is built as a decentralized, open-source Cosmos SDK blockchain that leverages intuitive ideas to scale. Notably,
                      BitBadges supports multiple methods of storing balances depending on the use case, including storing balances off-chain where
                      users never need to interact with the blockchain and pay gas fees. Learn more about the options{' '}
                      <a href="https://docs.bitbadges.io/overview/concepts/balances-types" target="_blank">
                        here
                      </a>
                      .
                    </Typography.Text>
              ...
              <LandingCard
                ...
                content={
                  <>
                    <FileProtectOutlined className="figma-blue" style={{ fontSize: 48 }} />
                    <br />
                    <br />
                    <Typography.Text strong className="primary-text" style={{ fontSize: 20 }}>
                      Token Standard
                    ...
                    <br />
                    <Typography.Text className="secondary-text" style={{ fontSize: 14, marginTop: 8 }}>
                      The BitBadges token (badge) standard is state-of-the-art compared to existing token standards (ERC20, ERC721, etc) and does not
                      require smart contracts. The standard is ever-evolving and natively supports never-before-seen features like time-dependent
                      ownership, fine-grained transferability requirements, and hybrid off-chain balances. Learn more
                      <a href="https://docs.bitbadges.io/overview/" target="_blank">
                        {' '}
                        here
                      </a>
                      .
      ...
      <div className="landing-padding mt-4">
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }} className="">
          {tools.map((tool, idx) => {
            ...
            return (
              <div style={{ margin: 8, display: 'flex' }} key={idx}>
