              ...
              <Content style={{ padding: '15px', maxWidth: 600 }} className="primary-text">
                <Content>
                  <Text strong style={{ fontSize: 20 }} className="primary-text">
                    {message ? message : 'It looks like you have not claimed your airdrop yet!'}
                  </Text>
                </Content>
                <br />
                <div className="flex-center">
                ...
                <div className="secondary-text" style={{ alignItems: 'center' }}>
                  <InfoCircleOutlined style={{ marginRight: 4 }} /> All transactions on the BitBadges blockchain require a small fee to be executed,
                  which can be paid using $BADGE. $BADGE is the currency, whereas BitBadges / badges are the tokens used to represent achievements,
                  attendance, etc. Note the airdrop badge may take a few minutes to appear in your portfolio.
                </div>
                <br />
                <div className="flex-center">
                  <button
