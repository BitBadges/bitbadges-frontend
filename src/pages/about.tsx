  ...
  return (
    ...
    >
              ...
              <>
                  ...
                  content={
                    <>
                      <div className="flex-center" style={{ alignItems: 'center' }}>
                        <Avatar src={'./images/andrew.png'} size={120} style={{ marginRight: 8 }} />
                      </div>
                      <br />
                      ...
                      <Typography.Text className="secondary-text" style={{ fontSize: 14, marginTop: 8 }}>
                        Andrew has built technologies for over 37 startups (as of EOY 2022) and has a profific history of entrepreneurship. He
                        recognized the need of BitBadges to transform into an independent blockchain and stop reliance on centralized platforms.
                        Andrew is leading BitBadges on business development, growth, and structure as well as consulting on special research,
                ...
                <LandingCard
                  ...
                  content={
                    <>
                      <div className="flex-center" style={{ alignItems: 'center' }}>
                        <Avatar src={'./images/trevor.jpg'} size={120} style={{ marginRight: 8 }} />
                      </div>
                      <br />
                      ...
                      <Typography.Text className="secondary-text" style={{ fontSize: 14, marginTop: 8 }}>
                        Trevor is the CTO and Founder of BitBadges. Trevor graduated with a 4.0 GPA from Virginia Tech in Computer Science, and has
                        been enthusiastic in disrupting the blockchain industry and learning more about its technologies. He conceptualized and built
                        BitBadges 1.0 and helped lead the way in building and infrastructure for BitBadges to be an independent blockchain.
                      </Typography.Text>
                    </>
                  }
                />
      ...
      <div className="landing-padding" style={{ textAlign: 'center' }}>
        ...
        <Row className="flex-between mt-4" style={{ alignItems: 'normal' }}>
          <Col md={24} sm={24} xs={24}>
            <Typography.Text strong className="secondary-text text-base secondary-text font-normal dark:text-slate-100" style={{ fontSize: 16 }}>
              ...
              To learn more and for more complete explanations,{' '}
              <a href="https://docs.bitbadges.io" target="_blank" className="text-vivid-blue" rel="noreferrer">
                  ...
                  content={
                    <>
                      <div style={{ textAlign: 'left' }}>
                        ...
                        <br />
                        <Typography.Text className="secondary-text" style={{ fontSize: 14, marginTop: 8 }}>
                          Digital blockchain tokens have great potential and infinitely many use cases, but the existing infrastructure is simply not
                          good enough. Existing interfaces are limited in functionality, lack consistency, limited scalability, and much more.
                          BitBadges aims to build out this infrastructure, so blockchain tokens can realize their potential. We aim to make blockchain
                          more accessible for everyone and build projects that are oriented towards adaptable, high-speed, peer-to-peer usecases.
                          {/* Through years of research, BitBadges is proud to introduce new features that have never been seen before in the blockchain space.<br /><br /> */}{' '}
                          Learn more{' '}
                          <a href="https://docs.bitbadges.io" target="_blank" className="text-vivid-blue" rel="noreferrer">
                            here
                  ...
                  content={
                    <>
                      <div style={{ textAlign: 'left' }}>
                        ...
                        <br />
                        <Typography.Text className="secondary-text" style={{ fontSize: 14, marginTop: 8 }}>
                          We keep decentralization as a core principle, as opposed to some of our competitors who rely on more centralized
                          architectures and censoring.
                        </Typography.Text>
                        <br />
                        <br />
                        <Typography.Text className="primary-text" strong style={{ fontSize: 16, marginTop: 8 }}>
                        ...
                        <br />
                        <Typography.Text className="secondary-text" style={{ fontSize: 14, marginTop: 8 }}>
                          Instead of relying on a rigid token standard that is not adaptable to new features, we iterate fast and constantly add new
                          features to our token standard.
                        </Typography.Text>
                        <br />
                        <br />
                        <Typography.Text className="primary-text" strong style={{ fontSize: 16, marginTop: 8 }}>
                        ...
                        <br />
                        <Typography.Text className="secondary-text" style={{ fontSize: 14, marginTop: 8 }}>
                          By being open-source and developer friendly, we aim to facilitate an ecosystem of community-driven projects, tools, and more
                          built on top of BitBadges.
                        </Typography.Text>
                        <br />
                        <br />
                        <Typography.Text className="primary-text" strong style={{ fontSize: 16, marginTop: 8 }}>
                  ...
                  content={
                    <>
                      <div style={{ textAlign: 'left' }}>
                        ...
                        <br />
                        <Typography.Text className="secondary-text" style={{ fontSize: 14, marginTop: 8 }}>
                          BitBadges offers several opportunities for creators whether it is for artists, event management, or musicians. For example,
                          ticket badges can be created for events, concerts, etc. Using BitBadges, the tickets can be distributed in a peer-to-peer
                          manner (no trusted third party), are more secure, more maintainable and much cheaper!
                        </Typography.Text>
                        <br />
                        <br />
                        <Typography.Text className="primary-text" strong style={{ fontSize: 16, marginTop: 8 }}>
                        ...
                        <br />
                        <Typography.Text className="secondary-text" style={{ fontSize: 14, marginTop: 8 }}>
                          Badges can be used for memberships and offering gated utility only to members. Because badges are stored on the blockchain,
                          no one can forge, censor, or modify memberships in an undesired manner.
                        </Typography.Text>
                        <br />
                        <br />
                        <Typography.Text className="primary-text" strong style={{ fontSize: 16, marginTop: 8 }}>
                        ...
                        <br />
                        <Typography.Text className="secondary-text" style={{ fontSize: 14, marginTop: 8 }}>
                          Badges are a great way to verify and display your achievements. We envision that displaying educational achievements as
                          badges will be a popular use case moving forward.
                        </Typography.Text>
                        <br />
                        <br />
                        <Typography.Text className="primary-text" strong style={{ fontSize: 16, marginTop: 8 }}>
        ...
        <br />
        <Col md={24} sm={24} xs={24}>
          <Typography.Text strong className="secondary-text text-base secondary-text font-normal" style={{ fontSize: 16 }}></Typography.Text>
        </Col>
      </div>
